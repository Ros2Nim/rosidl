...
// with input from test_interface_files:msg/Arrays.idl
...
bool
test_interface_files__msg__Arrays__init(test_interface_files__msg__Arrays * msg)
{
  if (!msg) {
    return false;
  }
...
void
test_interface_files__msg__Arrays__fini(test_interface_files__msg__Arrays * msg)
{
  if (!msg) {
    return;
  }
...
bool
test_interface_files__msg__Arrays__are_equal(const test_interface_files__msg__Arrays * lhs, const test_interface_files__msg__Arrays * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
test_interface_files__msg__Arrays__copy(
  const test_interface_files__msg__Arrays * input,
  test_interface_files__msg__Arrays * output)
{
  if (!input || !output) {
    return false;
  }
...
test_interface_files__msg__Arrays *
test_interface_files__msg__Arrays__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface_files__msg__Arrays * msg = (test_interface_files__msg__Arrays *)allocator.allocate(sizeof(test_interface_files__msg__Arrays), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(test_interface_files__msg__Arrays));
  bool success = test_interface_files__msg__Arrays__init(msg);
  if (!success) {
...
void
test_interface_files__msg__Arrays__destroy(test_interface_files__msg__Arrays * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    test_interface_files__msg__Arrays__fini(msg);
...
bool
test_interface_files__msg__Arrays__Sequence__init(test_interface_files__msg__Arrays__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface_files__msg__Arrays * data = NULL;

  if (size) {
    data = (test_interface_files__msg__Arrays *)allocator.zero_allocate(size, sizeof(test_interface_files__msg__Arrays), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = test_interface_files__msg__Arrays__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        test_interface_files__msg__Arrays__fini(&data[i - 1]);
      }
...
void
test_interface_files__msg__Arrays__Sequence__fini(test_interface_files__msg__Arrays__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      test_interface_files__msg__Arrays__fini(&array->data[i]);
    }
...
test_interface_files__msg__Arrays__Sequence *
test_interface_files__msg__Arrays__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface_files__msg__Arrays__Sequence * array = (test_interface_files__msg__Arrays__Sequence *)allocator.allocate(sizeof(test_interface_files__msg__Arrays__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = test_interface_files__msg__Arrays__Sequence__init(array, size);
  if (!success) {
...
void
test_interface_files__msg__Arrays__Sequence__destroy(test_interface_files__msg__Arrays__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    test_interface_files__msg__Arrays__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
test_interface_files__msg__Arrays__Sequence__are_equal(const test_interface_files__msg__Arrays__Sequence * lhs, const test_interface_files__msg__Arrays__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!test_interface_files__msg__Arrays__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
test_interface_files__msg__Arrays__Sequence__copy(
  const test_interface_files__msg__Arrays__Sequence * input,
  test_interface_files__msg__Arrays__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(test_interface_files__msg__Arrays);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    test_interface_files__msg__Arrays * data =
      (test_interface_files__msg__Arrays *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!test_interface_files__msg__Arrays__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          test_interface_files__msg__Arrays__fini(&output->data[i]);
        }
        return false;
      }
    }
