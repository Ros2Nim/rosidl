...
// with input from test_interface_files:msg/UnboundedSequences.idl
...
bool
test_interface_files__msg__UnboundedSequences__init(test_interface_files__msg__UnboundedSequences * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__boolean__Sequence__init(&msg->bool_values, 0)) {
    test_interface_files__msg__UnboundedSequences__fini(msg);
    return false;
  }
  // byte_values
  ...
  // basic_types_values
  if (!test_interface_files__msg__BasicTypes__Sequence__init(&msg->basic_types_values, 0)) {
    test_interface_files__msg__UnboundedSequences__fini(msg);
    return false;
  }
  // constants_values
  if (!test_interface_files__msg__Constants__Sequence__init(&msg->constants_values, 0)) {
    test_interface_files__msg__UnboundedSequences__fini(msg);
    return false;
  }
  // defaults_values
  if (!test_interface_files__msg__Defaults__Sequence__init(&msg->defaults_values, 0)) {
    test_interface_files__msg__UnboundedSequences__fini(msg);
    return false;
  }
  // bool_values_default
...
void
test_interface_files__msg__UnboundedSequences__fini(test_interface_files__msg__UnboundedSequences * msg)
{
  if (!msg) {
    return;
  }
  ...
  // basic_types_values
  test_interface_files__msg__BasicTypes__Sequence__fini(&msg->basic_types_values);
  // constants_values
  test_interface_files__msg__Constants__Sequence__fini(&msg->constants_values);
  // defaults_values
  test_interface_files__msg__Defaults__Sequence__fini(&msg->defaults_values);
  // bool_values_default
  rosidl_runtime_c__boolean__Sequence__fini(&msg->bool_values_default);
  // byte_values_default
  rosidl_runtime_c__octet__Sequence__fini(&msg->byte_values_default);
...
bool
test_interface_files__msg__UnboundedSequences__are_equal(const test_interface_files__msg__UnboundedSequences * lhs, const test_interface_files__msg__UnboundedSequences * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // basic_types_values
  if (!test_interface_files__msg__BasicTypes__Sequence__are_equal(
      &(lhs->basic_types_values), &(rhs->basic_types_values)))
  {
    return false;
  }
  // constants_values
  if (!test_interface_files__msg__Constants__Sequence__are_equal(
      &(lhs->constants_values), &(rhs->constants_values)))
  {
    return false;
  }
  // defaults_values
  if (!test_interface_files__msg__Defaults__Sequence__are_equal(
...
bool
test_interface_files__msg__UnboundedSequences__copy(
  const test_interface_files__msg__UnboundedSequences * input,
  test_interface_files__msg__UnboundedSequences * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // basic_types_values
  if (!test_interface_files__msg__BasicTypes__Sequence__copy(
      &(input->basic_types_values), &(output->basic_types_values)))
  {
    return false;
  }
  // constants_values
  if (!test_interface_files__msg__Constants__Sequence__copy(
      &(input->constants_values), &(output->constants_values)))
  {
    return false;
  }
  // defaults_values
  if (!test_interface_files__msg__Defaults__Sequence__copy(
...
test_interface_files__msg__UnboundedSequences *
test_interface_files__msg__UnboundedSequences__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface_files__msg__UnboundedSequences * msg = (test_interface_files__msg__UnboundedSequences *)allocator.allocate(sizeof(test_interface_files__msg__UnboundedSequences), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(test_interface_files__msg__UnboundedSequences));
  bool success = test_interface_files__msg__UnboundedSequences__init(msg);
  if (!success) {
...
void
test_interface_files__msg__UnboundedSequences__destroy(test_interface_files__msg__UnboundedSequences * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    test_interface_files__msg__UnboundedSequences__fini(msg);
...
bool
test_interface_files__msg__UnboundedSequences__Sequence__init(test_interface_files__msg__UnboundedSequences__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface_files__msg__UnboundedSequences * data = NULL;

  if (size) {
    data = (test_interface_files__msg__UnboundedSequences *)allocator.zero_allocate(size, sizeof(test_interface_files__msg__UnboundedSequences), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = test_interface_files__msg__UnboundedSequences__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        test_interface_files__msg__UnboundedSequences__fini(&data[i - 1]);
      }
...
void
test_interface_files__msg__UnboundedSequences__Sequence__fini(test_interface_files__msg__UnboundedSequences__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      test_interface_files__msg__UnboundedSequences__fini(&array->data[i]);
    }
...
test_interface_files__msg__UnboundedSequences__Sequence *
test_interface_files__msg__UnboundedSequences__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface_files__msg__UnboundedSequences__Sequence * array = (test_interface_files__msg__UnboundedSequences__Sequence *)allocator.allocate(sizeof(test_interface_files__msg__UnboundedSequences__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = test_interface_files__msg__UnboundedSequences__Sequence__init(array, size);
  if (!success) {
...
void
test_interface_files__msg__UnboundedSequences__Sequence__destroy(test_interface_files__msg__UnboundedSequences__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    test_interface_files__msg__UnboundedSequences__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
test_interface_files__msg__UnboundedSequences__Sequence__are_equal(const test_interface_files__msg__UnboundedSequences__Sequence * lhs, const test_interface_files__msg__UnboundedSequences__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!test_interface_files__msg__UnboundedSequences__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
test_interface_files__msg__UnboundedSequences__Sequence__copy(
  const test_interface_files__msg__UnboundedSequences__Sequence * input,
  test_interface_files__msg__UnboundedSequences__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(test_interface_files__msg__UnboundedSequences);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    test_interface_files__msg__UnboundedSequences * data =
      (test_interface_files__msg__UnboundedSequences *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!test_interface_files__msg__UnboundedSequences__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          test_interface_files__msg__UnboundedSequences__fini(&output->data[i]);
        }
        return false;
      }
    }
