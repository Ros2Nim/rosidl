...
// with input from test_interface_files:msg/Strings.idl
// generated code does not contain a copyright notice
#include "test_interface_files/msg/detail/strings__functions.h"
...
bool
test_interface_files__msg__Strings__init(test_interface_files__msg__Strings * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__String__init(&msg->string_value)) {
    test_interface_files__msg__Strings__fini(msg);
    return false;
  }
...
void
test_interface_files__msg__Strings__fini(test_interface_files__msg__Strings * msg)
{
  if (!msg) {
    return;
  }
...
bool
test_interface_files__msg__Strings__are_equal(const test_interface_files__msg__Strings * lhs, const test_interface_files__msg__Strings * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
test_interface_files__msg__Strings__copy(
  const test_interface_files__msg__Strings * input,
  test_interface_files__msg__Strings * output)
{
  if (!input || !output) {
    return false;
  }
...
test_interface_files__msg__Strings *
test_interface_files__msg__Strings__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface_files__msg__Strings * msg = (test_interface_files__msg__Strings *)allocator.allocate(sizeof(test_interface_files__msg__Strings), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(test_interface_files__msg__Strings));
  bool success = test_interface_files__msg__Strings__init(msg);
  if (!success) {
...
void
test_interface_files__msg__Strings__destroy(test_interface_files__msg__Strings * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    test_interface_files__msg__Strings__fini(msg);
...
bool
test_interface_files__msg__Strings__Sequence__init(test_interface_files__msg__Strings__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface_files__msg__Strings * data = NULL;

  if (size) {
    data = (test_interface_files__msg__Strings *)allocator.zero_allocate(size, sizeof(test_interface_files__msg__Strings), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = test_interface_files__msg__Strings__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        test_interface_files__msg__Strings__fini(&data[i - 1]);
      }
...
void
test_interface_files__msg__Strings__Sequence__fini(test_interface_files__msg__Strings__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      test_interface_files__msg__Strings__fini(&array->data[i]);
    }
...
test_interface_files__msg__Strings__Sequence *
test_interface_files__msg__Strings__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface_files__msg__Strings__Sequence * array = (test_interface_files__msg__Strings__Sequence *)allocator.allocate(sizeof(test_interface_files__msg__Strings__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = test_interface_files__msg__Strings__Sequence__init(array, size);
  if (!success) {
...
void
test_interface_files__msg__Strings__Sequence__destroy(test_interface_files__msg__Strings__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    test_interface_files__msg__Strings__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
test_interface_files__msg__Strings__Sequence__are_equal(const test_interface_files__msg__Strings__Sequence * lhs, const test_interface_files__msg__Strings__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!test_interface_files__msg__Strings__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
test_interface_files__msg__Strings__Sequence__copy(
  const test_interface_files__msg__Strings__Sequence * input,
  test_interface_files__msg__Strings__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(test_interface_files__msg__Strings);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    test_interface_files__msg__Strings * data =
      (test_interface_files__msg__Strings *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!test_interface_files__msg__Strings__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          test_interface_files__msg__Strings__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!test_interface_files__msg__Strings__copy(
